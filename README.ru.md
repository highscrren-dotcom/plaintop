...
|---|---|---|
| Сетевой интерфейс | первый настоящий интерфейс из дерева датчиков | редактор → «Блоки» → «Сеть», меню найденных интерфейсов |
...
| Текст заголовка | настройка | редактор → «Вид» |
...
- **«Общее»** — заголовок, шрифт, кегль, размер виджета, отступ от края, интервал обновления,
  как часто читать список процессов.
